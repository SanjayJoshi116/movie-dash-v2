const LANGUAGE_MAP: Record<string, string> = {
  ...
  mi: 'Māori', mr: 'Marathi', mh: 'Marshallese', mn: 'Mongolian', na: 'Nauru',
  ...
  os: 'Ossetian', pa: 'Punjabi', pi: 'Pāli', fa: 'Persian', pl: 'Polish',
  ...
  sn: 'Shona', si: 'Sinhala', sk: 'Slovak', sl: 'Slovenian', so: 'Somali',
